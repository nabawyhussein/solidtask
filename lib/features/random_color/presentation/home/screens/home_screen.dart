          ...
          child:
            ...
            builder: (context, state) {
              return Container(
                ...
                color:
                    state is NewColorGenerated ? state.newColor : Colors.white,
                alignment: Alignment.center,
                child: Text(
                  ConstantsManger.homeScreenCenterTxt,
                  style: Theme.of(context).textTheme.bodyLarge!.copyWith(
                      fontWeight: FontWeight.bold,
                      fontSize: AppScreenSize.responsiveTextValue(
                          context, ConstantsManger.homeScreenTxtSize),
                      color: Colors.black),
                ),
              );
            },
